/**
 * Monalisa FAQ Bot — pure keyword matching, zero external APIs.
 */
...
const FAQ_RULES = [
  ...
  {
    keywords: ['trainer', 'monalisa', 'who', 'instructor', 'experience', 'teacher'],
    response:
      'Monalisa is our lead trainer with 10+ years of WMS implementation experience across global clients.',
  },
  {
    keywords: ['hi', 'hello', 'hey', 'good morning', 'good evening'],
    response:
      "Hello! 👋 I'm Monalisa. How can I help you today? Ask me about courses, pricing, job support, or anything else!",
  },
];
