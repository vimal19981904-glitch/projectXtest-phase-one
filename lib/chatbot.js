...
const FAQ_RULES = [
  ...
  {
    keywords: ['trainer', 'amy', 'spain', 'who', 'instructor', 'experience', 'teacher'],
    response:
      'Amy Spain is our lead trainer with 10+ years of WMS implementation experience across global clients.',
  },
  {
    keywords: ['hi', 'hello', 'hey', 'good morning', 'good evening'],
    response:
      "Hello! 👋 I'm Amy Spain. How can I help you today? Ask me about training, pricing, job support, or anything else!",
  },
];
